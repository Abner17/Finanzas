...
{
    public partial class Frm_ContaMdi : Form
    {
        public Frm_ContaMdi()
        {
            InitializeComponent();
        ...
        {
            Frm_Data_Activos datactivos = new Frm_Data_Activos();
            datactivos.Show();
        }
        ...
        private void mantenimientosImuestosToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            Frm_Data_Catalogo dataCatalogo = new Frm_Data_Catalogo();
            dataCatalogo.Show();
        }
    }
}
