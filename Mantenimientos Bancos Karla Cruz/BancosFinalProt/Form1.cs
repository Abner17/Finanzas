...
namespace BancosFinalProt
{
    public partial class Mdi_Principal : Form
    {
        ...
        private void mantenimientosConceptoBancarioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_Data_ConBancario dataBancario = new Frm_Data_ConBancario();
            dataBancario.Show();
        }

        private void matenimientoCuentaBancariaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_Data_cuentaBancaria dataCuenta = new Frm_Data_cuentaBancaria();
            dataCuenta.Show();
        }

        private void mantenimientoMonedaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_Data_Moneda Moneda = new Frm_Data_Moneda();
            Moneda.Show();
        }
    }
}
