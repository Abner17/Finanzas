...
namespace BancosFinalProt
{
    public partial class Mdi_Principal : Form
    {
        ...
        private void generacionChequesPlanillaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_ListaChequesPlanilla frmChequesPlanilla = new Frm_ListaChequesPlanilla();
            frmChequesPlanilla.Show();
        }
    }
}
